 ...
 */
 ...
 $config['base_url'] = "http://".$_SERVER['HTTP_HOST']."/RPDigitel/paas-port/"; 
 define('MAINBASEURL','http://'.$_SERVER["HTTP_HOST"].'/RPDigitel/');
...
/*
  ...
  |
 */
// $config['encryption_key'] = 'vcard_encryptionalgorithmsapplied';
