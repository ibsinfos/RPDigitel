...
<div class="subnavbar">
    <div class="subnavbar-inner">
        <div class="container">
            <ul class="mainnav">
                <li class="<?php if ($page == 'dashboard' || $page == 'textmsg' || $page == 'appointment' || $page == 'autoresponder' || $page =='newautoresponder' || $page =='add_oppointment' || $page =='mmslist') echo 'active'; ?>"><a href="<?php echo base_url() ?>dashboard">
				<img src="<?php echo base_url() ?>media/img/icon/Dashboard.png" width="30"/>
				<span>Dashboard</span> </a> </li>
                <!--<li class="<?php if ($page == 'features') echo 'active'; ?>"><a href="#"><i class="icon-list-alt"></i><span>Features</span> </a> </li>-->
                <li class="<?php if ($page == 'contacts') echo 'active'; ?>"><a href="<?php echo base_url() ?>contacts">
				<img src="<?php echo base_url() ?>media/img/icon/Contact.png" width="30"/>
...
<!-- Below code Added and commented by ranjit on 26 april 2017 to vcard-manage menu in inner header -->                
				...
				<li class="<?php if ($page == 'vcard-manage' || $page == 'vcard-edit' || $page == 'reports' || $page == 'vcard-steps') echo 'active'; ?>"><a href="<?php echo base_url() ?>paasport-manage">
				<img src="<?php echo base_url() ?>media/img/icon/manage_vcard.png" width="30"/>
				<span>Manage Paasport</span> </a> </li>
