...
<html lang="en">
    <head>
        ...
        <title><?php
            ...
            ?></title>
        <link rel="stylesheet" href="<?php echo asset_url(); ?>stripe/css/bootstrap-min.css">
        <link rel="stylesheet" href="<?php echo asset_url(); ?>stripe/css/bootstrap-formhelpers-min.css" media="screen">
        <link rel="stylesheet" href="<?php echo asset_url(); ?>stripe/css/bootstrapValidator-min.css"/>
        <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" />
        <link rel="stylesheet" href="<?php echo asset_url(); ?>stripe/css/bootstrap-side-notes.css" />
        <style type="text/css">
            .col-centered {
        ...
        <script src="<?php echo asset_url(); ?>stripe/js/bootstrap-min.js"></script>
        <script src="<?php echo asset_url(); ?>stripe/js/bootstrap-formhelpers-min.js"></script>
        <script type="text/javascript" src="<?php echo asset_url(); ?>stripe/js/bootstrapValidator-min.js"></script>
                    ...
                    <div class="form-group">
                        <div class="panel panel-success">
                            ...
                            <div class="panel-body">
                                <p>Your card will be charged 30&euro; after submit.</p> 
