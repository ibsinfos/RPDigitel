...
<html lang="en">
    <head>
        ...
        <meta name="author" content="Prith-v COmmunications">
        <meta name="keyword" content="Courier Management Application">
    ...
    <body class="login-body">
        ...
        <div class="container">
            ...
            <form name="frm_admin_login" id="frm_admin_login" action="<?php echo base_url(); ?>backend/Login/adminlogin" method="post" class="form-signin">
                <?php
                if (isset($arr) != '') {
                    echo $arr['msg'];
                }
                ...
                <div class="login-wrap">
                    <input type="text" name="user_name"  id="user_name" class="form-control" placeholder="User ID" autofocus>
