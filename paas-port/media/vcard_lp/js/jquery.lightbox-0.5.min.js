	...
	$.fn.lightBox = function(settings) {
		...
		function _start(objClicked,jQueryMatchedObj) {
			...
			if ( jQueryMatchedObj.length == 1 ) {
				settings.imageArray.push(new Array(objClicked.getAttribute('href'),objClicked.getAttribute('data-title')));
			} else {
				// Add an Array (as many as we have), with href and title atributes, inside the Array that storage the images references		
				for ( var i = 0; i < jQueryMatchedObj.length; i++ ) {
					settings.imageArray.push(new Array(jQueryMatchedObj[i].getAttribute('href'),jQueryMatchedObj[i].getAttribute('data-title')));
				}
			}
		...
		function _set_image_to_view() { // show the loading
			...
			objImagePreloader.onload = function() {
				...
				viewPortDimensions = ___getPageSize();
		...
		function _resize_container_image_box(intImageWidth,intImageHeight) {
			console.log('_resize_container_image_box('+intImageWidth+','+intImageHeight+')');
		...
		{
			//console.log('___calculateImageDimension('+viewPortWidth+', '+viewPortHeight+', '+imageWidth+', '+imageHeight+')');
			...
			{
				newImageWidth = newViewPortWidth-20;				
