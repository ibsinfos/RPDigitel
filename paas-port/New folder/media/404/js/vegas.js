 ...
 * --------------------------------------------------------------------------*/
 ...
 $(document).ready(function(){
    ...
    $("body").vegas({
        slides: [
            { src: "http://localhost/vcard/media/404/img/home-slide-1.jpg" },
            { src: "http://localhost/vcard/media/404/img/home-slide-2.jpg" },
            { src: "http://localhost/vcard/media/404/img/home-slide-3.jpg" }
        ],
