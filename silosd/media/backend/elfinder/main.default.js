...
(function(){
	var // jQuery and jQueryUI version
		...
		opts = {
			url : 'http://54.212.235.115/silosd/media/elfinder/php/connector.minimal.php?follow='+user_id, // connector URL (REQUIRED)
	...
	require.config({
		baseUrl : 'http://54.212.235.115/silosd/media/backend/elfinder/js/',
		paths : {
