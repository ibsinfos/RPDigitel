    ...
    <div class="container">
        <div class="topbar-left-items">
            <ul class="toplist pull-left">
				...
				<li class="lineright"><a href="http://crm.rebelute.in">CRM Admin Login</a></li>				<li class=""><a href="http://54.209.190.106/landingpage/">Create Silo site</a></li>
            </ul>
        </div>
        <!--end left-->      
            ...
            <div class="navbar navbar-default orange2 yamm dark">
                ...
                <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
                    <ul class="nav orange2 navbar-nav">
                        ...
                        <li class="dropdown yamm-fw"> <a href="http://52.23.218.153/cart.php?a=add&domain=register" class="dropdown-toggle">BUY A DOMAIN</a></li>
                        <li class="dropdown yamm-fw"> <a href="http://52.23.218.153/cart.php" class="dropdown-toggle">ORDER HOSTING</a></li>
