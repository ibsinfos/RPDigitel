					...
					<td>
						<div class="btn-group">
							...
							<ul class="dropdown-menu dropdown-default" role="menu">
								...
								<li class="divider"></li>
								<li>
									<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?employee/product_category/delete/<?php echo $row['product_category_code'];?>' , 
																			'<?php echo base_url();?>index.php?employee/reload_product_category_table')">
