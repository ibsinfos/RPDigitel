				...
				<table class="table table-bordered datatable" id="table-3">
					...
					<?php foreach($sales_orders as $row):?>
						...
						<tr>
							<td>
								<strong>
									<a href="<?php echo base_url();?>index.php?employee/sales_order_view/<?php echo $row['order_code'];?>/<?php echo $redirect;?>" style="color: #949494;">
							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-default" role="menu">
										<li>
											<a href="<?php echo base_url();?>index.php?employee/sales_order_view/<?php echo $row['order_code'];?>/<?php echo $redirect;?>">
										...
										<?php if($row['order_status'] == 0):?>
											<li class="divider"></li>
											<li>
												<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?employee/sales_order/delete/<?php echo $row['order_code'];?>' , 
																			'<?php echo base_url();?>index.php?employee/sales_order_list/order_all')">
										...
										<?php if($row['order_status'] == 4):?>
											<li class="divider"></li>
											<li>
												<a href="<?php echo base_url();?>index.php?employee/sales_order/archive/<?php echo $row['order_code'];?>">
