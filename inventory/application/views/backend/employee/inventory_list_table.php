				...
				<table class="table table-bordered datatable" id="table-3">
					<thead>
						<tr class="replace-inputs">
							...
							<th><?php echo get_phrase('available_stock');?></th>
						...
						?>
							<tr>
								...
								<td>
									...
									?>
									<strong>
										<a href="<?php echo base_url();?>index.php?employee/product_details/<?php echo $row['product_code'];?>" style="color: #949494;">
											<?php echo $row['name'];?>
										</a>
									</strong>
									<?php if($variant > 1):?>
								...
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu dropdown-default" role="menu">
											<li>
												<a href="<?php echo base_url();?>index.php?employee/product_details/<?php echo $row['product_code'];?>">
											...
											<li class="divider"></li>
											<li>
												<a href="#" onclick="confirm_modal_2('<?php echo base_url();?>index.php?employee/product/archive/<?php echo $row['product_id'];?>' ,
									                        '<?php echo base_url();?>index.php?employee/inventory_list_archived')">
