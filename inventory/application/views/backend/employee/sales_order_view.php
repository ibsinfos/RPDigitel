		...
		<div class="panel panel-primary" data-collapsed="1">
			<div class="panel-heading">
				...
				<div class="panel-options">
					...
					<a href="#" onclick="confirm_modal_2('<?php echo base_url();?>index.php?employee/sales_order/mark_as_paid/<?php echo $order_code;?>' ,
									                        '<?php echo base_url();?>index.php?employee/sales_order_view/<?php echo $order_code;?>/overview')"
					...
					&nbsp; &nbsp;
					<a href="#" onclick="confirm_modal_2('<?php echo base_url();?>index.php?employee/sales_order/mark_as_delivered/<?php echo $order_code;?>' ,
									                        '<?php echo base_url();?>index.php?employee/sales_order_view/<?php echo $order_code;?>/overview')"
						class="tooltip-primary" data-toggle="tooltip"
