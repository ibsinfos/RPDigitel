							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-default" role="menu">
										...
										<li>
											<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?employee/variant/delete/<?php echo $variant['variant_id'];?>' , 
												'<?php echo base_url();?>index.php?employee/product_details/<?php echo $row['product_code'];?>')">
