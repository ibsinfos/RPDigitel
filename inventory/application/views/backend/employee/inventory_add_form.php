<?php echo form_open(base_url() . 'index.php?employee/product/create/' , array(
					...
					<div id="variant_entry">
						...
						<div class="row">
							...
							<div class="col-sm-2" style="width: 10%;">
								...
								<input type="number" id="initial_stock" class="form-control" name="quantity[]" max = 0 min = 0>
							</div>
...
<div class="row">
	<button type="submit" id="submit_button" class="btn btn-green btn-icon icon-left" style="margin-left: 12px;">
