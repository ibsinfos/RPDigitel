<?php 
	$info = $this->db->get_where('product_category' , array(
		'product_category_code' => $param2
	))->result_array();
	foreach($info as $row):
?>
<div class="row">
	<div class="col-md-12">
		...
		<div class="panel panel-default" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<?php echo form_open(base_url() . 'index.php?employee/product_category/edit/'.$param2 , array(
...
<script type="text/javascript">
	...
	var post_refresh_url	=	'<?php echo base_url();?>index.php?employee/reload_product_category_table';
	var post_message		=	'<?php echo get_phrase('product_category_edited_successfully');?>';
...
<script type="text/javascript">
	...
	function validate(formData, jqForm, options) { 
		...
		var name  =	$('#name').val();
		if (name == '') {
			toastr.error("<?php echo get_phrase('enter_category_name');?>", error);
			return false;
