<?php 
	$info = $this->db->get_where('tax' , array(
		'tax_id' => $param2
	))->result_array();
	foreach($info as $row):
?>
		...
		<div class="panel panel-default" data-collapsed="0">
			...
			<div class="panel-heading">
				<div class="panel-title">
					<?php echo get_phrase('edit_tax');?>
				</div>
			</div>
			
			<div class="panel-body">
				
				<?php echo form_open(base_url() . 'index.php?admin/tax/edit/' . $param2 , array(
...
<script type="text/javascript">
	...
	var post_message		=	'<?php echo get_phrase('tax_updated_successfully');?>';
