								...
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu dropdown-default" role="menu">
											...
											<li>
												<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/shipment_courier/shipping_method_delete/<?php echo $row['shipping_method_id'];?>' , 
																			'<?php echo base_url();?>index.php?admin/reload_shipment_courier_list')">
								...
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu dropdown-default" role="menu">
											...
											<li>
												<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/shipment_courier/courier_service_delete/<?php echo $row['courier_id'];?>' , 
																			'<?php echo base_url();?>index.php?admin/reload_shipment_courier_list')">
													<i class="entypo-trash"></i> <?php echo get_phrase('delete');?>
												</a>
											</li>
