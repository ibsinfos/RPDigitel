<?php 
	$info = $this->db->get_where('shipping_method' , array(
		'shipping_method_id' => $param2
	))->result_array();
	foreach($info as $row):
?>
<div class="row">
		...
		<div class="panel panel-default" data-collapsed="0">
			...
			<div class="panel-heading">
				<div class="panel-title">
					<?php echo get_phrase('edit_shipping_method');?>
				</div>
			</div>
			
			<div class="panel-body">
				
				<?php echo form_open(base_url() . 'index.php?admin/shipment_courier/shipping_method_edit/'. $param2 , array(
...
<script type="text/javascript">
	...
	var post_refresh_url	=	'<?php echo base_url();?>index.php?admin/reload_shipment_courier_list';
	var post_message		=	'<?php echo get_phrase('shipping_method_updated_successfully');?>';
...
<script type="text/javascript">
	...
	function validate(formData, jqForm, options) { 
		...
		var name    =	$('#name').val();
		if (name == '') {
			toastr.error("<?php echo get_phrase('enter_method_name');?>", error);
			return false;
