								...
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu dropdown-default" role="menu">
											...
											<li class="divider"></li>
											<li>
												<a href="#" onclick="confirm_modal_2('<?php echo base_url();?>index.php?admin/product/archive/<?php echo $row['product_id'];?>' ,
									                        '<?php echo base_url();?>index.php?admin/inventory_list_archived')">
