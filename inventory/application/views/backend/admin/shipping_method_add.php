	...
	<div class="col-md-12">
		...
		<div class="panel panel-default" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<?php echo form_open(base_url() . 'index.php?admin/shipment_courier/shipping_method_add/' , array(
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" id="name" class="form-control" name="name"
								placeholder="<?php echo get_phrase('shipping_method_name');?>">
						</div>
					</div>
...
<script type="text/javascript">
	...
	var post_message		=	'<?php echo get_phrase('shipping_method_added_successfully');?>';
