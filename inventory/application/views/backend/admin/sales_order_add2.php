...
<script type="text/javascript">
	...
	$('#billing_address_alert').hide();
	$('#shipping_address_alert').hide();
...
<script type="text/javascript">
	function show_alert() {
		if($('#billing_address_alert').val() == '')
			$('#billing_address_alert').show();
		else
			$('#billing_address_alert').hide();

		if($('#shipping_address_alert').val() == '')
			$('#shipping_address_alert').show();
		else
			$('#shipping_address_alert').hide();
	}
	...
	$('#submit_button').on('click', function() {
		...
		} else if($('#shipping_address_id').val() != '' && $('#billing_address_id').val() != '') {
