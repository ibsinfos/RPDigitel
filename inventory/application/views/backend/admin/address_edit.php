	...
	<div class="col-md-12">
		...
		<div class="panel panel-default" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<?php echo form_open(base_url() . 'index.php?admin/address/edit/' . $param2 , array(
...
<script type="text/javascript">
	...
	var post_refresh_url	=	'<?php echo base_url();?>index.php?admin/reload_user_profile_body/<?php echo $param3;?>';
