<div class="form-group">
	...
	<div class="col-sm-7">
		<select name="billing_address_id" class="selectboxit" id="billing_address_id" required>
...
<div class="form-group">
	...
	<div class="col-sm-7">
		<select name="shipping_address_id" class="selectboxit" id="shipping_address_id" required>
