				...
				<table class="table table-bordered datatable" id="table-3">
					...
					<?php foreach($purchase_orders as $row):?>
						<tr>
							<td>
								<strong>
									<a href="<?php echo base_url();?>index.php?admin/purchase_order_view/<?php echo $row['purchase_order_code'];?>" style="color: #949494;">
							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-default" role="menu">
										<li>
											<a href="<?php echo base_url();?>index.php?admin/purchase_order_view/<?php echo $row['purchase_order_code'];?>">
												<i class="entypo-direction"></i> <?php if($row['order_status'] < 2) echo get_phrase('process'); else echo get_phrase('view');?>
											</a>
										</li>
										<?php if($row['order_status'] == 0):?>
											<li>
												<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/purchase_order/delete/<?php echo $row['purchase_order_code'];?>' , 
																			'<?php echo base_url();?>index.php?admin/purchase_order_list/order_all')">
										...
										<?php if($row['order_status'] == 2):?>
											<li class="divider"></li>
											<li>
												<a href="<?php echo base_url();?>index.php?admin/purchase_order/archive/<?php echo $row['purchase_order_code'];?>"
