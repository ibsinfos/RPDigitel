            ...
            <ul class="col-lg-6 dropdown-menu mega-dropdown-menu row">
                <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card-deck container col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <img class="card-img-top img-responsive center-block card-img"
                                 src="<?php echo asset_url(); ?>main_vcard/images/services/fiberrails%20main96x86.png" alt="Card image cap"
                                 style="height: 77px;">
                        ...
                        <div class="card col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <img class="card-img-top img-responsive center-block card-img"
                                 src="<?php echo asset_url(); ?>main_vcard/images/services/silo%20main%20logo.png" alt="Card image cap" height="66"
                        ...
                        <div class="card col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <img class="card-img-top img-responsive center-block card-img"
                                 src="<?php echo asset_url(); ?>main_vcard/images/services/scandisc%20main%20logo.png" alt="Card image cap" width="189"
                    ...
                    <div class="card-deck container col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-top-25">
                        <div class="card col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <img class="card-img-top img-responsive center-block card-img"
                                 src="<?php echo asset_url(); ?>main_vcard/images/services/wbssuite.png" alt="Card image cap" width="177" height="61"
                        ...
                        <div class="card col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <img class="card-img-top img-responsive center-block card-img"
                                 src="<?php echo asset_url(); ?>main_vcard/images/services/paasport.png" alt="Card image cap" height="39" width="136"
                        ...
                        <div class="card col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <img class="card-img-top img-responsive center-block card-img"
                                 src="<?php echo asset_url(); ?>main_vcard/images/services/silobank.png" alt="Card image cap" width="77" height="60">
                            <div class="card-block">
