...
// Start Education ajax call		
        ...
        $('#btnsaveBlogAdd').on('click', function (e) {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>frontend/Vcard/saveBloginfo",
                type: "POST",
                ...
                success: function (data)
                {
                    ...
                    if (json.status === 1) {
						...
						var markup2 = "<tr class='blog-previewdetail-"+json.blogid+"'  ><td>" + blogtitle + "</td><td>" + blogshortdescr + "</td><td>" + bloglongdescr + "</td></tr>";
