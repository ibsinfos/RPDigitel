                    ...
                    <div class="tab-content">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                foreach ($user_exp_data as $user_exp) {
                                                                                    ...
                                                                                    <tr id="<?php echo ($user_exp['id']) ? $user_exp['id'] : ''; ?>">
                                                                                        <td><input name="record" type="checkbox"></td>
						...
						<div class="tab-pane fade" id="tab4default">
							...
							<div class="panel panel-success">
									...
									<img src="<?php echo asset_url(); ?>main_vcard/images/services/fiberrails main.png"/>
									<hr>
									<div class="embed-responsive embed-responsive-4by3">
									  <iframe class="embed-responsive-item" src="http://www.youtube.com/embed/JUIdarVPpsQ?rel=0&wmode=transparent"></iframe>
									</div>
							...
							<div class="panel panel-success">
									...
									<div class="linking"><a href="">Lorem ipsum dolor sit amet <span class="pull-right"><i class="fa fa-external-link" aria-hidden="true"></i></span></a></div>
									<div class="linking"><a href="">Lorem ipsum dolor sit amet <span class="pull-right"><i class="fa fa-external-link" aria-hidden="true"></i></span></a></div>
									<div class="linking"><a href="">Lorem ipsum dolor sit amet <span class="pull-right"><i class="fa fa-external-link" aria-hidden="true"></i></span></a></div>
							...
							<div class="panel panel-success">
									...
									<p>
									Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer tellus diam, convallis non placerat ac, suscipit at mauris. Duis ut venenatis mi, non gravida leo.
									</p>
                                                ...
                                                <div id="Portfolio" class="collapse padding-5"
												  ...
												  <div class="desc-panel" style="margin-top:48px">
													<div class="panel panel-success">
															...
															<div class="panel-body">
															<div class="panel-body-content text-center">
															<img class="img-responsive" src="<?php echo asset_url(); ?>main_vcard/images/services/fiberrails main.png"/>
															<hr>
															<div class="embed-responsive embed-responsive-4by3">
															  <iframe class="embed-responsive-item" src="http://www.youtube.com/embed/JUIdarVPpsQ?rel=0&wmode=transparent"></iframe>
															</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".preview-add-button1").click(function () {
            ...
            var markup = "<tr id=" + cnt + "><td><input type='checkbox' name='record'></td><td>" + prevCompanyName + "</td><td>" + prevJobTitle + "</td><td>" + prevStartDate + "</td><td>" + prevEndDate + "</td></tr>";
...
//            $('#prevCompanyName, #prevJobTitle, #prevStartDate1, #prevEndDate1').val("");
        ...
        $(".delete-row").click(function () {
            ...
            /*
             var delete_array=delete_exp_array;
             
             $.ajax({
             url: "<?php //echo base_url()  ?>frontend/Vcard/deleteExperience",
             type: "get",
             data: 'abc='+delete_array,
             contentType: false,
             cache: false,
             processData: false,
        ...
        $(".preview-add-button2").click(function () {
            ...
            var markup2 = "<tr id=" + cnt1 + "><td><input type='checkbox' name='record'></td><td>" + eduInstituteName + "</td><td>" + degree + "</td><td>" + eduStartDate1 + "</td><td>" + eduEndDate1 + "</td></tr>";
...
//                    alert('sdf');
		...
		//   Upload an image into pricing plan
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
															...
															<div class="form-group">
                                                                ...
                                                                <textarea id="pricingdescription" class="form-control" rows="3"></textarea>
                                                            </div>
														 ...
														 <div class="radio radio-primary col-md-4">
															...
															<div class="clear"></div>
															 ...
															 <div id="imagediv1" class="portfolioContent" style="display: block;">
																<div class="form-group">
																	<form id="example-2" action="index.html" method="POST" enctype="multipart/form-data" class="page">
															...
															<div class="form-group text-center">
															<button type="button" class="btn btn-danger width150">Add                                                 
															</button>
															</div>
