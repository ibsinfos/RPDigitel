<div class="container vcard-block card wizard-card" data-color="red">
    <div class=" vcard-box">
        <div class="row">
            <div>
                <h1 class="center"><b>BUILD</b> YOUR PASSPORT</h1>
                <h4 class="center" style="color:#8c8c8c">This information will get used to build your PASSPORT.</h4>
            </div>
                                                            ...
                                                            <div class="controls">
                                                                ...
                                                                <div id="main">
                                                                    ...
                                                                    <div class="remove-div" style="float:left;">
                                                                        ...
                                                                        <a id="btRemove" class="btn btn-primary btn-warning bt addbtn" href="#"  value="Add Skills" class="bt" style="float:left"><span class="glyphicon btn-glyphicon glyphicon-remove img-circle text-danger"></span> Remove Skills</a>
                                                                        <a id="btRemoveAll" class="btn btn-primary btn-warning bt addbtn" href="#"  value="Add Skills" class="bt" style="float:left"><span class="glyphicon btn-glyphicon glyphicon-trash img-circle text-danger"></span> Remove All Skills</a>

                                                                    </div>
                                                                    <br>																	
																	  <div id="updatedSkillData">
																		<?php
                                                                                $exp_count1 = 0;
																		...
																		<div class="form-group">
																			<input class="input_update form-control skill-text" name="txt_skill_update[]" id="tb_<?php echo $user_skill['id']; ?>" value="<?php echo $user_skill['skill']; ?>" type="text">
																			<input class="input_update_id form-control skill-text" name="txt_skill_update_id[]"  value="<?php echo $user_skill['id']; ?>" type="hidden">
																		</div>
																		<?php } ?>
																	</div>
                                                                    <div style="clear:both"></div>
																...
																<input type="button" class="bt btn btn-danger btn-sm" onclick="GetTextValue()"   id="btSubmit" value="Submit" />
																

                                                                <div id="blockSkillData" class="content-append">
                                        ...
                                        <div class="mobile-content mCustomScrollbar" id="preview"
                                            ...
                                            <div class="btn-group margin-top-5">
                                                ...
                                                <div id="skillsdata" class="collapse padding-5"
                                                     style="background:#f5f5f5; border-bottom-left-radius: 5px; border-bottom-right-radius: 5px;">
                                                    <div id="blockSkillDataMobile" class="content-append">
