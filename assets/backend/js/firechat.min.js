(function() {
    ...
    n.mixin = function(a) {
	  ...
	  return __p
        ...
        with(obj) __p += "<div class='clearfix'>\n<input data-input='firechat-room-name' type='text' placeholder='Enter Broadcast name' style='margin-bottom: 5px;' maxlength='" + __e(maxLengthRoomName) + "'>\n</div>";
        return __p
    ...
    function(a) {
        ...
        b.noConflict = function() {
            ...
            var a = this,
                ...
                c = this.prompt("Create Broadcast", b({
