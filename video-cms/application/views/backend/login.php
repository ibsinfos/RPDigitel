...
<html lang="en">
	...
	<body class="page-body login-page login-form-fall" data-url="http://neon.dev">
		...
		<script type="text/javascript">
			var login_url = '<?php echo site_url('login/ajax_login');?>';
			var login_redirect_url = '<?php echo site_url('login');?>'
		</script>
			...
			<div class="login-form">
				<div class="login-content">
					...
					<div class="login-bottom-links">
						<a href="<?php echo site_url('login/forgot_password');?>" class="link"><?php echo get_phrase('forgot_password');?> ?</a>
					</div>
				</div>
			</div>
		</div>
