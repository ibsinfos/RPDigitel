          ...
          <div class="col-sm-12">
            ...
            <a href="<?php echo site_url('admin/single_video_details/').$video['code']; ?>">
  			...
  			<div class="album-options col-sm-3">
  				<div class="row">
  					<div class="col-sm-1">
						<a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/video_edit_with_default_video_pack/'.$video['code']);?>')">
            ...
            <div class="col-sm-1"></div>
  					<div class="col-sm-1">
  						<a href="#" onclick="confirm_modal('<?php echo site_url('admin/videos/delete/'.$video['code']);?>',
												 '<?php echo site_url('admin/show_video_pack_details/'.$video_pack_code);?>')">
