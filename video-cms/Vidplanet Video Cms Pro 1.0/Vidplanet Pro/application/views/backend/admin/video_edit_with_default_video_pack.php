<?php
	...
	$video_pack_code = $this->db->get('video')->row_array();
	$this->db->where('code', $param2);
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				<!-- form start -->
				<?php echo form_open(site_url('admin/videos/do_update/'.$param2.'/default_video_pack/'.$video_pack_code['video_pack_code']), array(
