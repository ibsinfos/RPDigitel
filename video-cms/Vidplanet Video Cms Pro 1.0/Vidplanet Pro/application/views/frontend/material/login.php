      ...
      <div class="row">
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
          <div class="card card-signup">
            <form class="form" method="POST" action="<?php echo site_url('home/varify_user');?>">
              <div class="header header-<?php echo $color_scheme;?> text-center">
                <h4 class="card-title"><?php echo get_phrase('login'); ?></h4>
              ...
              <div class="content">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="email"
                    placeholder="<?php echo get_phrase('email');?>" autocomplete="off">
                </div>
                <div class="input-group">
                  <span class="input-group-addon">
                  ...
                  <input type="password" class="form-control" name="password"
                    placeholder="<?php echo get_phrase('password');?>" autocomplete="off">
                </div>
              </div>
              <div class="footer text-center">
                <button type="submit"
                  class="btn btn-<?php echo $color_scheme;?> btn-fab btn-fab-mini btn-round">
                  <i class="material-icons">done_all</i>
                </button>
                <br>
                <a href="<?php echo site_url('home/register');?>"
                  class="btn btn-<?php echo $color_scheme;?> btn-simple">
                  <?php echo get_phrase('do_not_have_account'); ?>
                </a>
              </div>
            </form>
          </div>
