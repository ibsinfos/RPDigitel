 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'sharmaparitosh7-facilitator_api1.gmail.com' : 'PRODUCTION_USERNAME_GOGES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? 'QUCPX7BMDWTD2BGK' : 'PRODUCTION_PASSWORD_GOGES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AUkH7M8f8dZWS9aJt3luVf-Wvj5hAIiIqEIb7X9mGupWmU8d5KDPsu6h' : 'PRODUCTION_SIGNATURE_GOGES_HERE';
 ...
 */
$config['ApplicationID'] = $config['Sandbox'] ? 'AQSOWZ1kZ5Pvc7PXT9WGQiMrv8OSUAeLtjEGChVxn0_-3hXgpninOv8R8CAFk6rzk86j86Jq0mG-MeDw' : 'PRODUCTION_APP_ID_GOES_HERE';
$config['DeviceID'] = '';
 ...
 */
$config['DeveloperEmailAccount'] = 'sharmaparitosh7-facilitator@gmail.com';
