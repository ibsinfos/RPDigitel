...
<div class="row" style="background: #f2f2f2">
    ...
    <!--<input type="text" class="form-control " id="userId" placeholder="Enter Username">-->
                    ...
                    <div class="form-group col-md-offset-1 col-md-10 col-xs-offset-2 col-xs-8">
                        <input type="email" class="form-control" id="email_address" name="email_address" required="required" placeholder="Enter email address">
                    </div>
                    <div class="form-group col-md-offset-1 col-md-5 col-xs-offset-2 col-xs-8">
                        <select name="country" id="country" class="form-control">
                            <option value="0" label="Select a country" selected="selected">Code</option>
                    ...
                    <div class="form-group col-md-5 col-xs-8 phone-no">
                    ...
                    <div class="form-group col-md-12 col-xs-12 center ">
                        <!--<button type="button" class="btn btn-danger" id="signup_button">Sign Up </button>-->

                        <?php if ($this->session->userdata('is_logged_in')) { ?>
                            <button type="button" class="btn btn-danger" id="signup_button_dummy">Sign Up</button>
                        <?php } else { ?>
                            <button type="button" class="btn btn-danger" id="signup_button">Sign Up</button>
                        <?php } ?>
                    ...
                    <div class="form-group  col-md-12 center">
                        <?php if ($this->session->userdata('is_logged_in')) { ?>
                            <button type="button" class="btn btn-danger btn-o" id="already_member_button_dummy">Already a Member? Login</button>
                        <?php } else { ?>
                            <button type="button" class="btn btn-danger btn-o" data-toggle="modal" data-target="#memberLogin">Already a Member? Login</button>
                        <?php } ?>
                    </div>
                </form>
            </div>
...
<div class="modal fade" id="memberLogin" role="dialog">
    <div class="modal-dialog">
        <form action="#" method="post" name="member_login" id="member_login">
            <header class="member_login">Paasport Login
            ...
            <div class="input_login_div">
                ...
                <input type="text" id="username" name="username" class="input-lg input-login member_login_input" placeholder="Enter Username" style="height: 40px;">
                <label class="form-login"><h4 style="margin-top:0px; margin-bottom:0px;">Password <span>*</span></h4></label>
                <input type="password" class="input-lg input-login member_login_input" name="password" id="password" placeholder="Password" style="height: 40px;">
                <input type="button" name="member_login_button" id="member_login_button" class="form-login1 member_login_input" value="Login">
            </div>
...
<script>
    $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data == 'true') {
                        ...
                        window.location = "<?php echo base_url(); ?>paasport";
                    } else {
        ...
        $('.member_login_input').keypress(function (e) {
        ...
        $('#signup_form').keypress(function (e) {
            if (e.which == 13) {//Enter key pressed
                $('#signup_button').click();//Trigger search button click event
            }
        });
        ...
        $("#signup_button_dummy").click(function () {
            // $("#errors").html("You are already logged in");
            $.toaster({priority: 'success', title: 'Message', message: 'You are already logged in'});
        });

        $("#already_member_button_dummy").click(function () {
            $.toaster({priority: 'success', title: 'Message', message: 'You are already logged in'});
        });
