    ...
    <div class="container padding-top-20 padding-bottom-20">
            ...
            <h3 class="white col-lg-12"> NAME YOUR PERSONAL CLOUD <small class="white">Starting from $9.99</small></h3>
                ...
                <div class="col-lg-6">
                    ...
                    <button type="button" class="btn btn-danger">SEARCH DOMAIN</button>
                </div>
             </div>
            <div class="col-lg-4 card-img hidden-xs hidden-sm">
...
<div class="row">
    <div class="container">
        <div class="col-lg-12">
        <div class="col-lg-offset-3 col-lg-1 hidden-xs hidden-sm"> <img src="<?php echo base_url(); ?>images/silo-sd/silosecureddata.png" height="100" width="60"></div>
        <h1 class="red col-lg-6 margin-bottom-0">Security As A Service</h1>
        <h4 class="red col-lg-6">Your Privacy, Your Data, Fully-encrypted, Forever Yours.</h4>
        </div>
        <div class="col-lg-12">
        ...
        <div class="col-lg-12 padding-top-20">
            <div class="col-lg-offset-3 col-lg-8">
                <div class="col-lg-3  col-sm-3 col-xs-12 silosd-img-mob">
                    <img src="<?php echo base_url(); ?>images/silo-sd/domain.png">
                    <h6 class="center">Choose Your Domain</h6>
                </div>
                <div class="col-lg-3 col-sm-3 col-xs-12 silosd-img-mob">
                    <img src="<?php echo base_url(); ?>images/silo-sd/hosting.png">
                    <h6 class="center">Personal Secured Webspace and Storage to be used as you wish...</h6>
                </div>
                <div class="col-lg-3 col-sm-3 col-xs-12 silosd-img-mob">
                    <img src="<?php echo base_url(); ?>images/silo-sd/website.png">
...
<div class="row">
    <div class="container margin-top-25">
        <div class="col-lg-offset-5 col-lg-2 col-xs-12">
...
<!--Section 3 End-->
<!--Section 4 Start-->
<div class="row" style="margin-left:0px; background: #0f0f0f">
    <div class="col-lg-1 padding-left-0" >
        <img src="<?php echo base_url(); ?>images/silo-sd/black-sd.jpg">
    </div>
    <div class="col-lg-offset-1 col-lg-10 padding-top-15">
        <h2 class="white">Extend your mobile device storage to your silocloud... <a href="" class="btn btn-danger btn-lg">Learn More</a></h2>
    </div>
...
<div class="row">
    <div class="container-fluid">
        <div class="col-lg-12">
        <div class="col-lg-offset-2 our-platform">
            <img src="<?php echo base_url(); ?>images/fiber-rails/our%20platform.png">
        </div>
        </div>
        <div class="col-lg-12">
           <ul class="margin-left-15 list-inline">
               <li class="col-lg-2 col-sm-3 col-xs-6">
                   <img src="<?php echo base_url(); ?>images/silo-sd/logos/WINDOWS.png">
               </li>
               <li class="col-lg-2 col-sm-3  col-xs-6">
                   <img src="<?php echo base_url(); ?>images/silo-sd/logos/APPLE.png">
               </li>
               <li class="col-lg-2 col-sm-3  col-xs-6">
                   <img src="<?php echo base_url(); ?>images/silo-sd/logos/lINUX.png">
               </li>
               <li class="col-lg-2 col-sm-3  col-xs-6">
                   <img src="<?php echo base_url(); ?>images/silo-sd/logos/ANDROID.png">
               </li>
               <li class="col-lg-2 col-sm-3  col-xs-6">
                   <img src="<?php echo base_url(); ?>images/silo-sd/logos/AMAZON.png">
               </li>
               <li class="col-lg-2 col-sm-3  col-xs-6">
                   <img src="<?php echo base_url(); ?>images/silo-sd/logos/lG.png">
               </li>
               <li class="col-lg-2 col-sm-3  col-xs-6 hidden-lg" >
                   <img src="<?php echo base_url(); ?>images/silo-sd/logos/SAMSUNG.png">
               </li>
               <li class="col-lg-2 col-sm-3  col-xs-6 hidden-lg">
                   <img src="<?php echo base_url(); ?>images/silo-sd/logos/NVIDIA.png">
               </li>
...
<div class="row" style="background: #8c8c8c">
    <div class="container-fluid">
        <div class="col-lg-6 padding-left-0 half-img">
            <img src="<?php echo base_url(); ?>images/silo-sd/datasecurityonredkeyboar_137471-752x471.jpg" >
        </div>
...
<div class="row">
    <div class="container-fluid ">
        <img src="<?php echo base_url(); ?>images/silo-sd/section-memory.jpg" class="banner-img hidden-xs">
    </div>
</div>
<!-- Section 7 End-->
<!-- Section 8 Start-->
<div class="row">
    <div class="container">
        <div class="col-lg-4">
            <img src="<?php echo base_url(); ?>images/silo-sd/device.png">
        </div>
        <div class="col-lg-6 cards">
            <img src="<?php echo base_url(); ?>images/cards.png">
        </div>
    </div>
</div>
<!-- Section 8 End-->
...
<div class="row" style="background: #808080">
    <div class="container-fluid">
        <div class="col-lg-offset-5 col-lg-2 col-xs-offset-1 ">
...
<div class="row">
    <div class="container">
        ...
        <div class="col-lg-offset-2 retailers-img">
        <div class="col-lg-3 col-sm-3 margin-left-20 margin-10">
            <img src="<?php echo base_url(); ?>images/silo-sd/metropcs-logo.png">
        </div>
        <div class="col-lg-3 col-sm-3 margin-10">
            <img src="<?php echo base_url(); ?>images/silo-sd/cricket-logo2.png">
        </div>
        <div class="col-lg-3 col-sm-3 margin-10">
            <img src="<?php echo base_url(); ?>images/silo-sd/staples-crop-u20681.png">
        </div>
        </div>
    </div>
</div>
...
<div class="row margin-top-25">
    <div class="container">
        <div class="col-lg-12">
        <div class="col-lg-offset-5 col-lg-2 col-xs-offset-2 col-sm-offset-4 col-xs-10 ">
            <img src="<?php echo base_url(); ?>images/silo-sd/silocloud.png" height="100">
        </div>
        </div>
...
<div class="row">
    <div class="container">
        <div class="col-lg-3 pricing-table">
            <h2 class="center">Starter<br>
                Try Scandisc free
            <br><small>$</small>0<br><small>NEVER EXPIRES</small>
            </h2>
            <button type="button" class="btn btn-danger" style="margin-left: 30%;">FREE SIGNUP</button>
        ...
        <div class="margin-left-70 col-lg-3 pricing-table">
            <h2 class="center">Starter<br>
                Try Scandisc free
                <br><small>$</small>9<sup>99</sup><br><small>NEVER EXPIRES</small>
            </h2>
            <button type="button" class="btn btn-danger" style="margin-left: 30%;">CUSTOMIZE</button>
            <p class="padding-top-10">
                <strong>Cloud storage:</strong><br>
                1TB secure storage
                <br>
        ...
        <div class="margin-left-70 col-lg-3 pricing-table">
            ...
            <button type="button" class="btn btn-danger" style="margin-left: 30%;">ENROLL</button>
            <p class="padding-top-10">
                <strong>Cloud storage:</strong><br>
                1TB secure storage
                <br>
...
<div class="row margin-top-25">
    <div class="container">
        ...
        <div class="col-lg-12">
            <ul class="margin-left-15 list-inline">
                <li class="col-lg-2 col-sm-3 col-xs-6">
                    <img src="<?php echo base_url(); ?>images/silo-sd/1.png">
                </li>
                <li class="col-lg-2 col-sm-3  col-xs-6">
                    <img src="<?php echo base_url(); ?>images/silo-sd/2.png">
                </li>
                <li class="col-lg-2 col-sm-3  col-xs-6">
                    <img src="<?php echo base_url(); ?>images/silo-sd/3.png">
                </li>
                <li class="col-lg-2 col-sm-3  col-xs-6">
                    <img src="<?php echo base_url(); ?>images/silo-sd/4.png">
                </li>
                <li class="col-lg-2 col-sm-3  col-xs-6">
                    <img src="<?php echo base_url(); ?>images/silo-sd/5.png">
                </li>
                <li class="col-lg-2 col-sm-3  col-xs-6">
                    <img src="<?php echo base_url(); ?>images/silo-sd/6.png">
                </li>
            </ul>
        </div>
...
<!--Section 14 End-->
<div class="row">
    <div class="container-fluid fiber-rails-mob-img">
        <img src="<?php echo base_url(); ?>images/silo-sd/fibrails.png" alt=""
    >
    </div>
</div>
<!--Section 14 End-->
