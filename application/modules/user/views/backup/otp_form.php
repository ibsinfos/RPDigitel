...
<html lang="en">
    ...
    <body>
            ...
            <div class="container topnav">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="<?php echo base_url(); ?>login/signup" class="top-navlinks" style="background-color: #FF0000; ">Sign Up</a>
						</li>
                        <li>
                            <!--    <a href="#" class="top-navlinks">Login</a>-->
						</li>
            ...
            <div>
                ...
                <div id="demo" class="collapse" style="background: #ffffff; ">
                    <div class="col-md-6 " style="background: #ffffff;">
                        <div class="col-md-2 hidden-xs hidden-sm"> <img class="block" id="u45305_img" src="<?php echo base_url(); ?>images/scandisc%20box82x82.png?crc=4246127547" alt="" width="70" height="70" style="margin-left: 30px; margin-top: 80px;"></div>
                        <div class="col-md-6 hidden-xs hidden-sm"><img class="block" id="u45381_img" src="<?php echo base_url(); ?>images/thingorilla_business_135.jpg?crc=290504810" alt="" width="330" height="220" style="margin-top:80px; margin-bottom:106px;"></div>
					</div>
        ...
        <div class="title " style="margin-bottom:0px; padding-bottom:0px;">
            <div class="container">
                <div class="container">
                    <div class="row login">
                        ...
                        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 well" style="margin-bottom:0px;">
                            <form role="form" method="post" id="otp_form">
                                ...
                                <div class="form-group col-md-offset-1 col-md-10">
                                    <input type="text" class="otp_input form-control input-lg" id="input_otp" name="input_otp" required="required" placeholder="Enter OTP here">
								</div>
                                <div class="form-group col-md-offset-3 col-md-6">
                                    <button type="button" class="btn btn-default btn-red btn-md btn-block" id="verify_otp_button">Verify</button>
                                    <button type="button" class="btn btn-default btn-red btn-md btn-block" id="resend_otp_button">Resend OTP</button>
								</div>
                                <div class="form-group last-row">
                                    <label id="sign_up">
                                        <a href="<?php echo base_url(); ?>login" style="color:#ffffff; font-weight:100;">Sign in with another account</a>
									</label>
								</div>
							</form>
						</div>
