            ...
            <div class="container topnav">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <!--   <a href="#" class="top-navlinks" style="background-color: #FF0000; ">Create a Profile</a>-->
                        </li>
                        <li>
                            <a href="<?php echo base_url(); ?>login" class="top-navlinks" style="background-color: #FF0000; ">Sign In</a>
                            <!--                            <a href="<?php //echo base_url();       ?>user/Login" class="top-navlinks">Login</a>-->
                        </li>
                        ...
                        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 well" style="margin-bottom:0px;">
                            <form role="form" action="<?php echo base_url(); ?>login/create_member" method="post" id="signup_form">
                                ...
                                <div class="form-group col-md-offset-1 col-md-10">
								   ...
								   <div class="form-group col-md-offset-1 col-md-10">
                                    <input type="text" class="signin_input form-control input-lg" id="phone_number" name="phone_number" placeholder="Enter Phone Number">
                                </div>
                                <div class="form-group col-md-offset-1 col-md-10">
                                ...
                                <div class="form-group last-row">
                                    <label >
                                        <a href="<?php echo base_url(); ?>login" style="color:#ffffff; font-weight:100;">Sign In For Fibre Rails</a>
                                    </label>
                                </div>
                            </form>
                        </div>
