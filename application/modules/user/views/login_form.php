                        ...
                        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 well" style="margin-bottom:0px;">
                            <form role="form" action="<?php echo base_url(); ?>login/validate_credentials" method="post" id="signin_form">
                                ...
                                <div class="form-group last-row">
                                    <label id="sign_up">
                                        <a href="<?php echo base_url(); ?>login/signup" style="color:#ffffff; font-weight:100;">Sign Up For Fibre Rails</a>
									</label>
								</div>
							</form>
						</div>
                ...
                success: function (data) {
                    ...
                    if (json.two_way_authentication == 'true') 
					{
						...
						{	
							...
							window.location = "<?php echo base_url(); ?>main_dashboard";
						}	
					} 
					else if (json.otp == 'otp')
					{
                        window.location = "<?php echo base_url(); ?>otp";
					} 
					else 
					{
						$('#password').val("");
