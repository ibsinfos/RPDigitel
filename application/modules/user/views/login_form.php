            ...
            <div class="container topnav">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="<?php echo base_url(); ?>user/Login/signup" class="top-navlinks" style="background-color: #FF0000; ">Sign Up</a>
						</li>
                        <li>
                        ...
                        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 well" style="margin-bottom:0px;">
							<form role="form" action="<?php echo base_url(); ?>user/Login/validate_credentials" method="post" >
                                ...
                                <div class="form-group last-row">
                                    <label id="sign_up">
                                        <a href="<?php echo base_url(); ?>user/Login/signup" style="color:#ffffff; font-weight:100;">Sign Up For Fibre Rails</a>
									</label>
								</div>
							</form>
						</div>
										...
										<div class="container">
											<div class="row">
												<div class="col-lg-12">
													...
													$('#signup_form').show();
													//  document.getElementById("signin_signup_form").innerHTML = "abc";
