...
<html>
	...
	<body>
		  ...
		  <div class="carousel-inner" role="listbox">
		    <div class="item active">
		      ...
		      <div class="carousel-caption">
		        ...
		        <h5>Business Line and Personal Line on a 2017 Dual Sim Smartphone</h5>
		        <button class="btn">Take it Away</button>
		        <p>Get the All New <strong>Scandisc UGC Media Package</strong> when you have the RP Digital Bundal for Business Wireless plan.</p>
		      </div>
		    </div>
		    <div class="item">
		...
		<div id="carousel-home-smartphone" class="carousel slide" data-ride="carousel">
		  <!-- Wrapper for slides -->
		  <div class="carousel-inner" role="listbox">
		    <div class="item active">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4 text-center">
						...
						<button class="btn btn-lg">Load More!</button>
						<span>View more articles ></span><br>
		...
		<section class="startShopping text-center">
						...
						<div class="panel">
						  	...
						  	<div class="panel-body">
							    ...
							    <ul class="list-unstyled typoList">
									<li>11.6-inch Full HD touchscreen display</li>
									<li>Intel i3, i5 or i7 6th Generation</li>
									<li>Pen Optional</li>
									<li>Windows 10</li>
									<li>8GB/64GB eMMC</li>
									<li>Up to 12 hour battery life</li>
								</ul>
								<p class="price">Now $349.00</p>
							</div>
						</div>
					</div>
					<div class="col-sm-6 col-md-3">
						<div class="panel">
						  	...
						  	<div class="panel-body">
							    ...
							    <ul class="list-unstyled typoList">
									<li>12-inch Full HD touchscreen display</li>
									<li>Intel i3, i5 or i7 6th Generation</li>
									<li>Pen Optional</li>
									<li>Windows 10</li>
									<li>8GB/64GB eMMC</li>
					...
					<div class="col-sm-6 col-md-3">
						<div class="panel">
						  	...
						  	<div class="panel-body">
							    ...
							    <ul class="list-unstyled typoList">
									<li>HDMI Ready</li>
									<li>Bluetooth hub, 802.11 wifi connect</li>
									<li>Intel i3, i5 or i7 6th Generation</li>
									<li>USB 4.0</li>
									<li>64GB/64GB eMMC</li>
									<li>Up to 12 hour battery life</li>
								</ul>
								<p class="price">Now $199.00</p>
							</div>
						</div>
					</div>
					<div class="col-sm-6 col-md-3">
						<div class="panel">
						  	...
						  	<div class="panel-body">
							    ...
							    <ul class="list-unstyled typoList">
									<li>Crystal Clear 5.6" Display</li>
									<li>17.5 hous Talk Time</li>
									<li>13MP Main Camera 5MP FFC</li>
									<li>Dual Sim Dual Standby</li>
									<li>Unlocked GSM/WCDMA Channels</li>
									<li>1.6 Ghz Processing Capacity</li>
								</ul>
								<p class="price">Now $449.00</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-sm-5 col-md-4">
						<div class="tryOut text-center">
							<h4 class="heading">Try out our Drag &amp; Drop Dynamic Site Builder</h4>
							<p>Enterprise Solutions built for Startups.</p>
							<button class="btn btn-lg btn-block btnRed">Launch Site Builder Trial</button>
							<span>View more articles ></span><br>
							<a href="" class="signUpLink">Sign up for a new merchant account</a>
						</div>
					</div>
		...
		<section class="siloCloudSection">
			<div class="container">
				<div class="row">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-10 col-md-8 text-center">
						<div class="well">
							<h4 class="heading1">Any cloud based services can boast about a platform.</h4>
							<h3 class="heading2">We'd like to talk about our handrails!</h3>
							<div class="clearfix">
								<p class="pull-left">Find a developer</p><br>
								<button class="btn btnRed btn-lg pull-right">Ask about how Fiber Rails Can Assist You</button>
							</div>
						</div>
						<p>Free Training Resources Available.</p>
						<h4 class="applyText">Would you like to join our network of e commerce developers? Learn how you can apply.</h4>
					</div>
				</div>
			</div>
		</section>
