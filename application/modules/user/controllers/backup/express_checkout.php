...
//		die('Here');
        ...
        $SECFields = array(
            ...
            'returnurl' => site_url('user/express_checkout/GetExpressCheckoutDetails'), // Required.  URL to which the customer will be returned after returning from PayPal.  2048 char max.
            'cancelurl' => site_url('user/express_checkout/OrderCancelled'), // Required.  URL to which the customer will be returned if they cancel payment on PayPal's site.
...
// die('ss');  
	if (!$this->paypal_pro->APICallSuccessful($PayPalResult['ACK'])) {
            ...
            $data['main_content'] = 'paypal/demos/express_checkout/paypal_error';
            ...
            redirect(base_url().'wbs_suite/wbs_subscribe_payment_success');
...
//        print_r($SetExpressCheckoutPayPalResult); die();
        ...
        if (!$this->paypal_pro->APICallSuccessful($PayPalResult['ACK'])) {
            ...
            // Successful Order
            redirect('frontend/express_checkout/OrderComplete');
        }
    }
    ...
    function OrderComplete() {
        ...
        $this->template->build('paypal/demos/express_checkout/payment_complete');
