		...
		<div class="mailBoxWrap">
			<aside class="sm-side">
				<div class="user-head">
					...
					<div class="user-name">
						<h5 class="text-uppercase"><a href="#">Alireza Zare</a></h5>
						<span>Senior Desiger</span>
					</div>
				</div>
				<div class="inbox-body">
					<a href="#composeMailModal" data-toggle="modal" title="Compose" class="btn btnRed btn-compose">
						Compose
					</a>
				</div>
...
<!-- Modal -->
<div aria-hidden="true" aria-labelledby="composeMailModalLabel" role="dialog" tabindex="-1" id="composeMailModal" class="modal fade" style="display: none;">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form role="form" class="form-horizontal">
					...
					<div class="form-group">
						<label class="col-xs-12 col-sm-2 control-label">Cc / Bcc</label>
						<div class="col-xs-12 col-sm-8">
					...
					<div class="form-group">
						<label class="col-xs-12 col-sm-2 control-label">Message</label>
						<div class="col-xs-12 col-sm-8">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<button class="btn btn-send" type="submit">Send Email</button>
						</div>
					</div>
				</form>
			</div>
