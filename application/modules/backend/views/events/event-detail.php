    ...
    <div class="row">
        <div class="col-sm-8 col-md-9">
            <div class="newsDetail">
                <?php if(file_exists("./uploads/events/".$event['event_image']) && $event['event_image'] !='') { ?>
                <img src="<?php  echo base_url()."uploads/events/".$event['event_image']?>" class="img-responsive newsImage">
                <?php }?>
                <h3 class="heading"><?php echo $event['event_name']?></h3>
                <ul class="list-unstyled list-inline">
                    <li class="postBy">By <strong>Admin</strong></li>
                    <li><i class="fa fa-calendar"></i> <?php echo date("d F Y",strtotime($event['start_date']))." - ".date("d F Y",strtotime($event['end_date']))?></li>
<!--                    <li><i class="fa fa-eye"></i> 25600</li>
                    <li><i class="fa fa-comments-o"></i> 56</li>-->
                </ul>
                <p><?php echo $event['long_desc']?></p>
            </div>
...
<!--            <div class="showComments">
        ...
        <div class="col-sm-4 col-md-3">
            ...
            <?php foreach($recent_event as $re){?>
            <?php if(file_exists("./uploads/events/".$re['event_image']) && $re['event_image'] !='') { ?>
            <a href="<?php echo base_url()."event/".$re['id']?>">
            <img src="<?php echo base_url()."uploads/events/".$re['event_image']?>" alt="banner1"  class="img-responsive">
             <?php }?>
            <h5 class="heading2"><?php echo $re['event_name']?></h5>
            </a>
            <p class="postDate"><i class="fa fa-calendar"></i> <?php echo date("d F Y",strtotime($re['created_time']))?></p>
