								...
								<div class="x_content">
									...
									<form id="demo-form2" enctype="multipart/form-data"  method="post" action="<?php echo base_url();?>add-news" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="form-group">
											...
											<input name="select_featured" value="divSelectFeatured" checked="checked" type="radio">Select Featured News
											<input name="select_featured" value="divAddFeatured"  type="radio">Add Featured News		
											</div>
										</div>
										...
										<div class="form-group">
											<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
												...
												<button type="submit" name="btnsubmitaddfeatured" class="btn btn-success">Submit</button>
											</div>
										</div>
