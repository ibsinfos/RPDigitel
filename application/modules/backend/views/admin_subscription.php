						...
						<!-- Nav tabs -->
					  	<ul class="nav nav-tabs" role="tablist">
							...
							<?php
								...
								?>
								<li role="presentation" class="<?php if($ser_count==0){ echo 'active';}?>"><a href="#<?php echo $service['category'].'_tab';?>" aria-controls="<?php echo $service['category'].'_tab';?>" role="tab" data-toggle="tab">
									<?php
					  	...
					  	<div class="tab-content">
							...
							<?php 
								...
								<div role="tabpanel" class="tab-pane <?php if($ser_tab_count==0){ echo 'active';}?>" id="<?php echo $service['category'].'_tab';?>">
									<div class="row">
							...
							<!--
								<div role="tabpanel" class="tab-pane active" id="fiber_tab">
						    	<div class="row">
								<div class="col-sm-4">
								<div class="panel plan1">
								<div class="panel-heading text-center">
								...
								<div role="tabpanel" class="tab-pane" id="wbs_tab">
						    	<div class="row">
								<div class="col-sm-4">
								<div class="panel plan1">
								<div class="panel-heading text-center">
