						...
						<div role="tabpanel" class="tab-pane active" id="basicInfo">
							<form class="form-horizontal" id="basicInformationForm" name="basicInformationForm">
								<ul class="list-unstyled list-inline">
									...
									<li>
										<?php if(!empty($basic_info_data)){ ?>
											<input type="text" name="publisher_application_id" id="publisher_application_id" value="<?php if(!empty($basic_info_data)){ echo $basic_info_data[0]['id'];}?>" hidden>
											<?php
											}
										?>
								...
								<div class="row">
									...
									<div class="col-xs-12 form-group businessStructureRadioWrap">
										<label class="radio-inline" data-business-structure="individuallyOwned">
											<input type="radio" name="businessStructureRadio" value="A" <?php if(!empty($basic_info_data)){ if($basic_info_data[0]['business_structure_cat']=='A'){ echo "checked";}}else{echo "checked";}?>> 
								...
								<br>
								<div class="businessStructureInfo individuallyOwned-information <?php if(!empty($basic_info_data)){ if($basic_info_data[0]['business_structure_cat']=='A'){ echo "active";}}else{ echo "active";}?>">
								...
								<div class="businessStructureInfo formallyOrganized-information <?php if(!empty($basic_info_data)){ if($basic_info_data[0]['business_structure_cat']=='B'){ echo "active";}}?>">
									...
									<div class="row">
										<div class="col-xs-12 col-sm-6 form-group">
											...
											<input type="text" class="form-control" id="foc_corporationName" name="foc_corporationName" placeholder="" value="<?php if(!empty($busi_foc_data)){ echo $busi_foc_data[0]['corporation_name'];}?>">
										</div>
										<div class="col-xs-12 form-group">
											<label class="radioLabel">Does this corporation have a division or DBA at ASCAP or SESAC?</label>
											<label class="radio-inline">
												<input type="radio" name="foc_is_corporationDivision" value="Y" <?php if(!empty($busi_foc_data)){ if($busi_foc_data[0]['is_corporation_division']=='Y'){ echo "checked";}}else{echo "checked";}?>> Yes
											</label>
											<label class="radio-inline">
												<input type="radio" name="foc_is_corporationDivision" value="N"  <?php if(!empty($busi_foc_data)){ if($busi_foc_data[0]['is_corporation_division']=='N'){ echo "checked";}}?>> No
											</label>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xs-12 col-sm-6 form-group">
											...
											<input type="text" class="form-control" id="foc_companyName" name="foc_companyName" placeholder="" value="<?php if(!empty($busi_foc_data)){ echo $busi_foc_data[0]['company_name'];}?>">
										</div>
										<div class="col-xs-12 col-sm-6 form-group">
											<label for="incorporationState">State of Incorporation:</label>
											<input type="text" class="form-control" id="foc_incorporationState" name="foc_incorporationState" placeholder="" value="<?php if(!empty($busi_foc_data)){ echo $busi_foc_data[0]['state_of_incorporation'];}?>">
										</div>
										<div class="col-xs-12 col-sm-6 form-group">
											<label for="taxIdentyNo">Tax Identification Number:</label>
											<input type="text" class="form-control" id="foc_taxIdentyNo" name="foc_taxIdentyNo" placeholder="" value="<?php if(!empty($busi_foc_data)){ echo $busi_foc_data[0]['tin'];}?>">
										</div>
										<div class="col-xs-12 form-group">
											<label class="radioLabel">Is your BMI publishing company a division or DBA of your corporation?</label>
											<label class="radio-inline">
												<input type="radio" name="foc_bmiDivisionRadio" value="Y"  <?php if(!empty($busi_foc_data)){ if($busi_foc_data[0]['is_corporation_division']=='Y'){ echo "checked";}}else{echo "checked";}?>> Division
											</label>
											<label class="radio-inline">
												<input type="radio" name="foc_bmiDivisionRadio" value="N" <?php if(!empty($busi_foc_data)){ if($busi_foc_data[0]['is_corporation_division']=='N'){ echo "checked";}}?>> DBA
											</label>
										</div>
									</div>
											...
											<div class="table-responsive">
												<table class="table table-bordered" id="table_stockholder_foc">
													...
													<tbody>
														...
														<?php 
															if(!empty($stockholders_data)){ 
																
																$stockholders_count=0;
																foreach($stockholders_data as $sd){
																	$stockholders_count++;
																	
																	echo "<tr id='new_".$stockholders_count."'><td><input type='hidden' name='foc_stock_stockholdersName[]' value='".$sd['name']."'>".$sd['name']."</td><td><input type='hidden' name='foc_stock_homeAddressZipCode[]' value='".$sd['address']."'>".$sd['address']."</td><td><input type='hidden' name='foc_stock_ssOrTaxId[]' value='".$sd['tax_id']."'>".$sd['tax_id']."</td><td><input type='hidden' name='foc_stock_percentageOfOwnership[]' value='".$sd['ownership_percentage']."'>".$sd['ownership_percentage']."</td><td><input type='hidden' name='foc_stock_isPublicklyTradedCorporation[]' value='".$sd['is_publicaly_traded']."'>".$sd['is_publicaly_traded']."</td><td><input style='text-align:right;' type='button' value='X' class='btn btn-sm btnRed' onclick=\"delete_selected_stockholder_foc('new_".$stockholders_count."')\" name='del_featureid' id='del_new".$stockholders_count."'></td></tr>";
											...
											<div class="table-responsive">
												<table class="table table-bordered" id="table_officer_foc">
													...
													<tbody>
														...
														<?php 
															if(!empty($officers_data)){ 
																
																$officers_count=0;
																foreach($officers_data as $officer){
																	$officers_count++;
																	
																	echo "<tr id='new_".$officers_count."'><td><input type='hidden' name='foc_officers_officerssName[]' value='".$officer['name']."'>".$officer['name']."</td><td><input type='hidden' name='foc_officers_homeAddressZipCode[]' value='".$officer['address']."'>".$officer['address']."</td><td><input type='hidden' name='foc_officers_ssOrTaxId[]' value='".$officer['tax_id']."'>".$officer['tax_id']."</td><td><input type='hidden' name='foc_officers_officeHeld[]' value='".$officer['office_held']."'>".$officer['office_held']."</td><td><input style='text-align:right;' type='button' value='X' class='btn btn-sm btnRed' onclick=\"delete_selected_officers_foc('new_".$officers_count."')\" name='del_officerid' id='del_new".$officers_count."'></td></tr>";
								...
								<div class="businessStructureInfo partnership-information <?php if(!empty($basic_info_data)){ if($basic_info_data[0]['business_structure_cat']=='C'){ echo "active";}}?>">
									...
									<div class="row">
										<div class="col-xs-12 col-sm-6 form-group">
											...
											<input type="text" class="form-control" id="p_taxIdentyNo" name="p_taxIdentyNo" placeholder="" value="<?php if(!empty($busi_partnership_data)){ echo $busi_partnership_data[0]['tin_ein'];}?>">
														...
														<?php 
															if(!empty($partners_data)){
																...
																foreach($partners_data as $partners){
																	...
																	echo "<tr id='new_".$partners_count."'><td><input type='hidden' name='foc_partners_Name[]' value='".$partners['name']."'>".$partners['name']."</td><td><input type='hidden' name='foc_partners_homeAddressZipCode[]' value='".$partners['address']."'>".$partners['address']."</td><td><input type='hidden' name='foc_partners_ssOrTaxId[]' value='".$partners['tax_id']."'>".$partners['tax_id']."</td><td><input type='hidden' name='foc_partners_percentageOfOwnership[]' value='".$partners['ownership_percentage']."'>".$partners['ownership_percentage']."</td><td><input style='text-align:right;' type='button' value='X' class='btn btn-sm btnRed' onclick=\"delete_selected_partners_foc('new_".$partners_count."')\" name='del_officerid' id='del_new".$partners_count."'></td></tr>";
								...
								<div class="businessStructureInfo formallyOrganizedLLC-information <?php if(!empty($basic_info_data)){ if($basic_info_data[0]['business_structure_cat']=='D'){ echo "active";}}?>">
									...
									<div class="row">
										<div class="col-xs-12 col-sm-6 form-group">
											...
											<input type="text" class="form-control" id="fol_nameOfLLC" name="fol_nameOfLLC" placeholder="" value="<?php if(!empty($busi_fol_data)){ echo $busi_fol_data[0]['llc_name'];}?>">
										</div>
										<div class="col-xs-12 col-sm-6 form-group">
											<label for="companyName">Company Name:</label>
											<input type="text" class="form-control" id="fol_companyName" name="fol_companyName" placeholder="" value="<?php if(!empty($busi_fol_data)){ echo $busi_fol_data[0]['company_name'];}?>">
										</div>
										<div class="col-xs-12 col-sm-6 form-group">
											<label for="incorporationState">State Where Organized:</label>
											<input type="text" class="form-control" id="fol_incorporationState" name="fol_incorporationState" placeholder="" value="<?php if(!empty($busi_fol_data)){ echo $busi_fol_data[0]['state'];}?>">
										</div>
										<div class="col-xs-12 col-sm-6 form-group">
											<label for="taxIdentyNo">Tax Identification Number:</label>
											<input type="text" class="form-control" id="fol_taxIdentyNo" name="fol_taxIdentyNo" placeholder="" value="<?php if(!empty($busi_fol_data)){ echo $busi_fol_data[0]['tin'];}?>">
										</div>
										<div class="col-xs-12 form-group">
											<label class="radioLabel">Is your BMI publishing company a division or DBA of your LLC?</label>
											<label class="radio-inline">
												<input type="radio" name="fol_bmiDivision" value="Y"  <?php if(!empty($busi_fol_data)){ if($busi_fol_data[0]['is_dba']=='Y'){ echo "checked";}}else{echo "checked";}?>> Division
											</label>
											<label class="radio-inline">
												<input type="radio" name="fol_bmiDivision" value="N" <?php if(!empty($busi_fol_data)){ if($busi_fol_data[0]['is_dba']=='N'){ echo "checked";}}?>> DBA
											</label>
										</div>
										<div class="col-xs-12">
														...
														<?php 
															if(!empty($members_data)){
																...
																foreach($members_data as $members){
																	...
																	echo "<tr id='new_".$members_count."'><td><input type='hidden' name='foc_members_Name[]' value='".$members['name']."'>".$members['name']."</td><td><input type='hidden' name='foc_members_homeAddressZipCode[]' value='".$members['address']."'>".$members['address']."</td><td><input type='hidden' name='foc_members_ssOrTaxId[]' value='".$members['tax_id']."'>".$members['tax_id']."</td><td><input type='hidden' name='foc_members_percentageOfOwnership[]' value='".$members['ownership_percentage']."'>".$members['ownership_percentage']."</td><td><input style='text-align:right;' type='button' value='X' class='btn btn-sm btnRed' onclick=\"delete_selected_members_foc('new_".$members_count."')\" name='del_officerid' id='del_new".$members_count."'></td></tr>";
													...
													<body>
														...
														<?php 
															if(!empty($managers_data)){
																...
																$managers_count=0;
																foreach($managers_data as $managers){
																	$managers_count++;
																	
																	echo "<tr id='new_".$managers_count."'><td><input type='hidden' name='foc_managers_Name[]' value='".$managers['name']."'>".$managers['name']."</td><td><input type='hidden' name='foc_managers_homeAddressZipCode[]' value='".$managers['address']."'>".$managers['address']."</td><td><input type='hidden' name='foc_managers_ssOrTaxId[]' value='".$managers['tax_id']."'>".$managers['tax_id']."</td><td><input type='hidden' name='foc_managers_is_have_authority[]' value='".$managers['have_authority']."'>".$managers['have_authority']."</td><td><input style='text-align:right;' type='button' value='X' class='btn btn-sm btnRed' onclick=\"delete_selected_managers_foc('new_".$managers_count."')\" name='del_officerid' id='del_new".$managers_count."'></td></tr>";
						...
						<div role="tabpanel" class="tab-pane" id="companyInfo">
							<form class="form-horizontal" id="companyInformationForm" name="companyInformationForm">
								...
								<div class="row">
									<div class="col-xs-12 col-sm-4">
										<?php if(!empty($basic_info_data)){ ?>
											<input type="text" name="c_publisher_application_id" id="c_publisher_application_id" value="<?php if(!empty($basic_info_data)){ echo $basic_info_data[0]['id'];}?>" hidden>
											<?php
											}
										?>
								...
								<div class="row">
									<div class="col-xs-12 form-group">
										...
										<label class="radio-inline">
											<input type="radio" name="companyInfoListed" value="Y" <?php if(!empty($company_info_data)){ if($company_info_data[0]['is_listed_on_bmi_website']=='Y'){ echo "checked";}}else{echo "checked";}?>> Yes
										</label>
										<label class="radio-inline">
								...
								<div class="row">
									<div class="col-xs-12 form-group">
										...
										<label class="radio-inline">
											<input type="radio" name="anotherBMICompany" value="Y" <?php if(!empty($company_info_data)){ if($company_info_data[0]['is_administratered_by_bmi']=='Y'){ echo "checked";}}else{echo "checked";}?>> Yes
										</label>
										<label class="radio-inline">
											<input type="radio" name="anotherBMICompany" value="N" <?php if(!empty($company_info_data)){ if($company_info_data[0]['is_administratered_by_bmi']=='N'){ echo "checked";}}?>> No
										</label>
									</div>
									<div class="col-xs-12 col-sm-6 form-group">
								...
								<div class="row">
									<div class="col-xs-12 form-group">
										...
										<label class="radio-inline">
											<input type="radio" name="contactAtBMI" value="Y"  <?php if(!empty($company_info_data)){ if($company_info_data[0]['is_representative_at_bmi']=='Y'){ echo "checked";}}else{echo "checked";}?>> Yes
										</label>
										<label class="radio-inline">
											<input type="radio" name="contactAtBMI" value="N" <?php if(!empty($company_info_data)){ if($company_info_data[0]['is_representative_at_bmi']=='N'){ echo "checked";}}?>> No
										</label>
									</div>
									<div class="col-xs-12 col-sm-6 form-group">
										...
										<tbody>
											...
											<?php
												...
												if(!empty($uploaded_files_data)){
													...
													foreach($uploaded_files_data as $uploaded_files){
														
														$uploaded_files_count++;
														
														echo "<tr id='file_row_".$uploaded_files_count."'><td>".$uploaded_files_count."</td><td>".basename($uploaded_files['file_path'])."</td><td>".pathinfo($uploaded_files['file_path'], PATHINFO_EXTENSION)."</td><td><input style='text-align:right;' type='button' value='Delete' class='btn btn-sm btnRed' onclick=\"delete_selected_files('file_row_".$uploaded_files_count."','".$uploaded_files['id']."')\" name='del_memberid' id='del_new".$uploaded_files_count."'></td></tr>";
...
<script type="text/javascript">
	...
	var delete_publisher_file_URL = '<?php echo  base_url();?>delete_publisher_file'; //refer \media\backend\js\dashboard-custom.js
