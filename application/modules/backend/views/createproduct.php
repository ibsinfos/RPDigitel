                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 form-group">
                                        ...
                                        <textarea class="form-control" id="businessAddress" rows="5" placeholder=""></textarea>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-6 form-group">
                                                <label for="businessPhone">Business Phone:</label>
                                                <input type="text" class="form-control" id="businessPhone" placeholder="">
                                            </div>
                                            <div class="col-xs-12 col-sm-6 form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 form-group">
                                        <label class="radio-inline" data-business-structure="individuallyOwned">
                                          <input type="radio" name="businessStructureRadio" value="" checked> 
                                          A. Individually Owned- Fee: $150.00
                                        </label>
                                        <label class="radio-inline" data-business-structure="formallyOrganized">
                                          <input type="radio" name="businessStructureRadio" value="">
                                ...
                                <div class="businessStructureInfo individuallyOwned-information">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 form-group">
                                            ...
                                            <input type="text" class="form-control" id="affiliationPeriod" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="businessStructureInfo formallyOrganized-information">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 form-group">
                                            ...
                                            <input type="text" class="form-control" id="corporationName" placeholder="">
                                        </div>
                                        <div class="col-xs-12 form-group">
                                            <label class="radioLabel">Does this corporation have a division or DBA at ASCAP or SESAC?</label>
                                            <label class="radio-inline">
                                              <input type="radio" name="corporationDivision" value="" checked> Yes
                                            </label>
                                            <label class="radio-inline">
                                              <input type="radio" name="corporationDivision" value=""> No
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 form-group">
                                            ...
                                            <input type="text" class="form-control" id="incorporationState" placeholder="">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 form-group">
                                        ...
                                        <div class="col-xs-12 form-group">
                                            ...
                                            <label class="radio-inline">
                                              <input type="radio" name="bmiDivisionRadio" value="" checked> Division
                                            </label>
                                            <label class="radio-inline">
                                              <input type="radio" name="bmiDivisionRadio" value=""> DBA
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="businessStructureInfo formallyOrganizedLLC-information">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 form-group">
                                            ...
                                            <input type="text" class="form-control" id="nameOfLLC" placeholder="">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 form-group">
                                            <label for="companyName">Company Name:</label>
                                            <input type="text" class="form-control" id="companyName" placeholder="">
                                        ...
                                        <div class="col-xs-12 form-group">
                                            ...
                                            <label class="radio-inline">
                                              <input type="radio" name="bmiDivision" value="" checked> Division
                                            </label>
                                            <label class="radio-inline">
                                              <input type="radio" name="bmiDivision" value=""> DBA
                                            </label>
                                        </div>
                                        <div class="col-xs-12">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 form-group">
                                        ...
                                        <label class="radio-inline">
                                          <input type="radio" name="companyInfoListed" value="" checked> Yes
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="companyInfoListed" value=""> No
                                        </label>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 form-group">
                                        ...
                                        <label class="radio-inline">
                                          <input type="radio" name="anotherBMICompany" value="" checked> Yes
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="anotherBMICompany" value=""> No
                                        </label>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 form-group">
                                        <label for="administratorName">Name of Administrator (please print)</label>
                                        <input type="text" class="form-control" id="administratorName" placeholder="">
                                    </div>
                                    <div class="col-xs-12 col-sm-6 form-group">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 form-group">
                                        ...
                                        <label class="radio-inline">
                                          <input type="radio" name="contactAtBMI" value="" checked> Yes
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="contactAtBMI" value=""> No
                                        </label>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 form-group">
                                        <label for="bmiContactName">If yes, please provide their name:</label>
                                        <input type="text" class="form-control" id="bmiContactName" placeholder="">
                                    </div>
                                    <div class="col-xs-12 text-right form-group">
                                        <button class="btn btnRed">Save</button>
                                    </div>
