						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									?>
									<form id="demo-form2" enctype="multipart/form-data"  method="post" action="<?php echo base_url();?>add-slider" data-parsley-validate class="form-horizontal form-label-left">
