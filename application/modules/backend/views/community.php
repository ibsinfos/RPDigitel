...
<div class="container-fluid communityWrap">
    <div class="row sliderNewsWrap">
        ...
        <div class="col-sm-6">
            <a href="<?php echo base_url() . "news/" . $category[0]['id']; ?>" class="newsWrap firstNews">
                <?php
            ...
            <a href="<?php echo base_url() . "news/" . $category[1]['id']; ?>" class="newsWrap secondNews">
                <?php
    ...
    <div class="row latestSectionWrap">
                            ...
                            <li class="row">
                                ...
                                <div class="col-md-8">
                                    <h5 class="category">
                                        ...
                                        ?></h5>
                                    <a href="<?php echo base_url() . "news/" . $n['id'] ?>"><p><?php echo $n['title'] ?></p></a>
                                </div>
                            </li>
                            <?php
                        }
            ...
            <div class="panel featuredNews topBorderPatch">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <h4><a href="<?php echo base_url() . "news/" . $featured[0]['id'] ?>"><?php
                            ...
                            <?php foreach ($featured as $featured) { ?>
                                <li class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <h4 class="heading4"><a href="<?php echo base_url() . "news/" . $featured['id'] ?>"><?php echo $featured['title']; ?></a></h4>
                                    </div>
                                </li>
                            <?php } ?>
                ...
                <div class="row">
                    ...
                    if (!empty($entertainment_category)) {
                        ...
                        foreach ($entertainment_category as $ec) {
                            ...
                            ?>
                            <div class="col-md-4">
                                <a href="<?php echo base_url() . "news/" . $ec['id'] ?>">
                ...
                <ul class="list-unstyled">
                    ...
                    if (!empty($fashion_category)) {
                        ...
                        foreach ($fashion_category as $fc) {
                            ...
                            ?>
                            <li class="row">
                                <a href="<?php echo base_url() . "news/" . $fc['id'] ?>">
                                    <div class="col-md-4 imageBlock">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        if (!empty($category_slider)) {
                            ...
                            foreach ($category_slider as $cs) {
                                ...
                                ?>" >
                                    <a href="<?php echo base_url() . "news/" . $cs['id'] ?>">
                ...
                <ul class="list-unstyled">
                    ...
                    if (!empty($other)) {
                        foreach ($other as $o_news) {
                            ...
                            ?>
                            <li class="row">
                                <a href="<?php echo base_url() . "news/" . $o_news['id'] ?>">
                                    <div class="col-md-4 imageBlock">
        ...
        <div class="col-sm-3">
            ...
            <div class="panel activeMembers">
                ...
                <div class="row">
                    <?php foreach($latest_users as $lu){?>
                     <?php if($lu['user_image'] !=''){?>
                    <div class="col-xs-6 col-sm-4 col-md-3">
                       
                        <img style="width:50px;height:50px" src="<?php echo base_url().$lu['user_image']?>" alt="" class="img-responsive">
