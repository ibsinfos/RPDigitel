            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        ?>
                        <form id="demo-form2" enctype="multipart/form-data"  method="post" action="<?php echo base_url() . "edit-category/" . $category[0]['id']; ?>" data-parsley-validate class="form-horizontal form-label-left">

                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Category <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="hidden" id="id" name="id" value="<?php echo $category[0]['id']; ?>" class="form-control col-md-7 col-xs-12">
                                    <input type="text" id="name" name="name"  value="<?php echo $category[0]['name']; ?>" class="form-control col-md-7 col-xs-12">
