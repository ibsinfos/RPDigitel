...
<script type="text/javascript">
    ...
    var removeSkillsAndExerptiseURL = "<?php echo base_url() ?>backend/paasport/removeSkillsAndExerptise";
    var removeAllSkillsAndExerptiseURL = "<?php echo base_url() ?>backend/paasport/removeAllSkillsAndExerptise";
    var saveSkillsURL = "<?php echo base_url() ?>backend/paasport/saveSkills";
    var deleteSkillURL = "<?php echo base_url() ?>backend/paasport/deleteSkill";
    var saveExperienceURL = "<?php echo base_url() ?>backend/paasport/saveExperience";
    var deleteExperienceURL = "<?php echo base_url() ?>backend/paasport/deleteExperience";
    var saveEducationURL = "<?php echo base_url() ?>backend/paasport/saveEducation";
    var deleteEducationURL = "<?php echo base_url() ?>backend/paasport/deleteEducation";
    var deleteblogURL = "<?php echo base_url() ?>backend/paasport/deleteblog";
    var deletePriceURL = "<?php echo base_url() ?>backend/paasport/deletePrice";
    var saveUserinfoURL = "<?php echo base_url() ?>backend/paasport/saveUserinfo";
    var saveCompanyInfoURL = "<?php echo base_url() ?>backend/paasport/saveCompanyInfo";
    var saveSocialInfoURL = "<?php echo base_url() ?>backend/paasport/saveSocialInfo";
    var saveShortBioURL = "<?php echo base_url() ?>backend/paasport/saveShortBio";
    var saveSkillsAndExerptiseURL = "<?php echo base_url() ?>backend/paasport/saveSkillsAndExerptise";
    var savePricePlanURL = "<?php echo base_url() ?>backend/paasport/savePricePlan";
    var savePricePlanImageURL = "<?php echo base_url() ?>backend/paasport/savePricePlanImage";
    var saveListURL = "<?php echo base_url() ?>backend/paasport/saveList";
    var saveLinkURL = "<?php echo base_url() ?>backend/paasport/saveLink";
    var saveVideoURL = "<?php echo base_url() ?>backend/paasport/saveVideoUrl";
    var savePortfolioURL = "<?php echo base_url() ?>backend/paasport/savePortfolio";
    var saveBloginfoURL = "<?php echo base_url() ?>backend/paasport/saveBloginfo";
    var getSkillsAndExerptiseURL = "<?php echo base_url() ?>backend/paasport/getSkillsAndExerptise";
    var getSkillsAndExerptDetailURL = "<?php echo base_url() ?>backend/paasport/getSkillsAndExerptDetail";
    var getExperienceDataURL = "<?php echo base_url() ?>backend/paasport/getExperienceData";
    var getExperienceDataMobileURL = "<?php echo base_url() ?>backend/paasport/getExperienceDataMobile";
    var getEducationDataURL = "<?php echo base_url() ?>backend/paasport/getEducationData";
    var getEducationDataMobileURL = "<?php echo base_url() ?>backend/paasport/getEducationDataMobile";
    var getListDataURL = "<?php echo base_url() ?>backend/paasport/getListData";
    var getMainListDataURL = "<?php echo base_url() ?>backend/paasport/getMainListData";
    var getListDataMobileURL = "<?php echo base_url() ?>backend/paasport/getListDataMobile";
    var getLinkDataURL = "<?php echo base_url() ?>backend/paasport/getLinkData";
