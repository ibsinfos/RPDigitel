...
<html lang="en">
    ...
    <body class="nav-md">
        ...
        <?php if ($page == 'project_list' || $page == 'news_list' || $page == 'featured_news' || $page == 'category_list' || $page == 'slider_list' || $page=='header_list' || $page=='category_list' || $page=='add_featured_news' || $page=='add_latest_news' || $page=='add_category_news') { ?>
