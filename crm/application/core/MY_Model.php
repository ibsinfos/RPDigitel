...
//        echo $this->db->last_query();die;            
      ...
      public function get_project($id = NULL, $single = FALSE) {
...
//        $config['max_height'] = '768';
  ...
  /*  
    public function get_where($where, $tbl_name) {
...
//            }
    ...
    public function get_permission_project($table, $flag = null) {
...
// $result_info = $this->db->where('org_id',$this->session->userdata('org_id'))->get($table)->result();
            ...
            $permission = $this->db->get_project($table)->result();
...
//            }
    ...
    /********************************** Code added by Ranjit on 10-04-2017 Start **********************************/

    public function get_permission_transaction($table, $flag = null) {
...
//             $permission = $this->db->get($table)->result();
            $permission = $this->db->where('org_id',$this->session->userdata('org_id'))->get($table)->result();
/*
            $this->db->select('*');
            $this->db->from($table);
