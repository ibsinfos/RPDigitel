                        ...
                        <tr>
                            ...
                            <td><?php if ($v_user->user_id != $this->session->userdata('user_id')): ?>
                                    <?php if (!empty($can_edit)) { ?>
                                        ...
                                        <?php else: ?>
                                            <?php 
												//Commented by ranjit on 26april 2017 to hide user edit button
											//echo btn_banned_modal('admin/user/change_banned/' . $v_user->user_id); ?>
                                        <?php endif; ?>
                                    <?php } ?>
                                    ...
                                    <?php if (!empty($can_edit)) { ?>
                                        <?php 
										//Commented by ranjit on 26april 2017 to hide user edit button
											//echo btn_edit('admin/user/user_list/edit_user/' . $v_user->user_id); ?>
                                    <?php }
                                    if (!empty($can_delete)) {
                                        ?>
                                        <?php 
											//Commented by ranjit on 26april 2017 to hide user delete button
											//echo btn_delete('admin/user/delete_user/' . $v_user->user_id); ?>
                                    <?php } ?>
                                <?php endif; ?>
                            </td>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select id="user_type" name="role_id" class="form-control" required>
                                    ...
                                    <option <?php
                                    if (!empty($login_info)) {
                                        echo $login_info->role_id == 4 ? 'selected' : '';
                                    }
                                    ?> value="4">Manager</option>
                                    <option <?php
                                    if (!empty($login_info)) {
