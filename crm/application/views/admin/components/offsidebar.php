    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" style="background:none;" id="control-sidebar-home-tab">
            <h2 style="color: #EFF3F4;font-weight: 100;text-align: center;">
                <?= $this->admin_model->get_days(date("l")); ?>
                <br/>
                ...
                $month = date("n");
                $year = date("Y");
                echo $days . " " . $this->admin_model->get_year($month) . ", " . $year; ?>
            </h2>
            <form action="<?= base_url() ?>admin/user/todo/add" method="post" class="form-horizontal form-groups"
                ...
                <div class="form-group col-sm-12">
                    ...
                    <input type="submit" value="<?= lang('add') ?>" class="btn btn-success btn-xs col-sm-3"/>
                </div>
            </form>
...
<script>
    $("#idCalculadora").Calculadora({'EtiquetaBorrar': '<?= lang('clear')?>', TituloHTML: ''});
</script>