...
<div class="row mt-lg">
    <div class="col-sm-3">
        <?php
        if ($leads_details->converted_client_id == 0 || $role == 4 ) {
            if (!empty($can_edit) || $role == 4 ) { ?>
            ...
            <?php if (!empty($can_delete) || $role == 4 ) { ?>
                    ...
                    <div class="panel-body row form-horizontal task_details">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a target="_blank" href="//<?php echo $leads_details->facebook; ?>">
                              <?php  } ?>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6"><label
                                ...
                                if (!empty($leads_details->twitter)) { ?>
                                   <a target="_blank" href="//<?php echo $leads_details->twitter; ?>">
                             <?php } ?>
                                    <p class="form-control-static"><?php
                                        if (!empty($leads_details->twitter)) {
                            ...
                            <div class="col-sm-6">
                               ...
                               <?php
                                if (!empty($leads_details->skype)) { ?>
                                    <a href="skype:'<?php echo $leads_details->skype; ?>'">
                              <?php } ?>
                                    <p class="form-control-static"><?php
                                        if (!empty($leads_details->skype)) {
