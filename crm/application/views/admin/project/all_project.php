        ...
        <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="create">
            <form role="form" enctype="multipart/form-data" id="form"
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label"><?= lang('fixed_rate') ?></label>
                        <div class="col-lg-6">
                            <div class="checkbox c-checkbox">
                                <label class="needsclick">
                                    <input type="checkbox" <?php
                                    if (!empty($project_info) && $project_info->fixed_rate == 'Yes') {
                                        echo 'checked';
                                    }
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox c-checkbox">
                                    <label class="needsclick">
                                        <input type="checkbox" <?php
                                        if (!empty($project_info) && $project_info->with_tasks == 'yes') {
                                            echo 'checked';
                                        }
                                        ?> name="with_tasks">
                                        <span class="fa fa-check"></span>
                    ...
                    ?>>
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                ...
                                ?>" class="form-control" placeholder="500" name="project_cost">
                            </div>
                        </div>
                    </div>
