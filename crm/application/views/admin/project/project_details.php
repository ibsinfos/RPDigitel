                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="form-control-static">
                                    ...
                                    <?php if ($project_details->fixed_rate == 'No') { ?>
                                        <small class="small text-muted">
                                            <?= $project_details->hourly_rate . "/" . lang('hour') ?>

                                            <?php if ($project_details->with_tasks == 'yes') { ?>
                                            (<?= lang('with_tasks')?>)
                                            <?php } ?>
                                        </small>
                                    <?php } ?>
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title"><?= lang('activities') ?>
                            ...
                            if ($role == 1) {
                                ?>
                                <span class="btn-xs pull-right">
                            <a onclick="return confirm('Are you sure to Clear Activities');" href="<?= base_url() ?>admin/tasks/claer_activities/project/<?= $project_details->project_id ?>"><?= lang('clear') . ' ' . lang('activities') ?></a>
                            </span>
                            <?php } ?>
                        </h3>
                    </div>
                ...
                <div class="panel panel-custom">
                    ...
                    <div class="panel-body chat" id="chat-box">
                        ...
                        <form id="form_validation" action="<?php echo base_url() ?>admin/project/save_comments"
                              method="post" class="form-horizontal" onsubmit="return validate_comments();">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <textarea class="form-control textarea"
                                              ...
                                              name="comment" id="comment" style="height: 70px;"></textarea>                                 <span style="display:none;color:red;" id="err_comment">Please Enter some text</span>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
            ...
            <div class="tab-pane <?= $active == 8 ? 'active' : '' ?>" id="task_notes"
                ...
                <div class="panel panel-custom">
                    ...
                    <div class="panel-body">
                        ...
                        ?>" enctype="multipart/form-data" method="post" id="form" class="form-horizontal" onsubmit="return validate_notes();">
                            <div class="form-group">
                                <div class="col-lg-12">
                                                <textarea class="form-control textarea"
                                                          name="notes" id="notes"><?= $project_details->notes ?></textarea>
                               <span style="display:none;color:red;" id="err_notes">Please Enter some text</span>							   </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <button type="submit" id="sbtn"
                    ...
                    <div class="tab-content bg-white">
                        ...
                        <div class="tab-pane <?= $time_active == 2 ? 'active' : ''; ?>" id="contact">
                            <form role="form" enctype="multipart/form-data" id="form"
                                  ...
                                  ?>" method="post" class="form-horizontal" onsubmit="return validate_timesheet();">
                                <?php
                                if (!empty($project_timer_info)) {
                                ...
                                <div class="form-group margin">
                                    <div class="col-sm-8 center-block">
                                        <label class="control-label"><?= lang('edit_reason') ?> <span
                                                class="required">*</span></label>
                                        <div>
                                                <textarea class="form-control" name="reason" id="reason" required="" rows="6"><?php
                                                    if (!empty($project_timer_info)) {
                                                        echo $project_timer_info->reason;
                                                    }
                                                    ?></textarea>
													
										<span style="display:none;color:red;" id="err_timesheet">Please Enter some text</span>			
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
	...
	{
		var comment = $('#task_comments .note-editable' ).text().trim();
		if(comment=="")
		{
			$("#err_comment").show();
			return false;
	...
	{
		var notes = $('#task_notes .note-editable' ).text().trim();
		if(notes=="")
		{
			$("#err_notes").show();
			return false;
