    ...
    <script>
        ...
        var buyerData = {
            ...
            labels: [
                ...
                $month_name = $this->admin_model->get_year($name);
                ?>
    ...
    <script>
        ...
        var buyerData = {
            ...
            labels: [
                ...
                $month_name = $this->admin_model->get_year($name); // get full name of month by date query
                ?>
                "<?php echo $month_name; ?>", // echo the whole month of the year
                <?php endforeach; ?>
            ],
    ...
    <script>
        ...
        var buyerData = {
            ...
            labels: [
                ...
                // yearle result name = month name
                for ($i = 1; $i <= 12; $i++) {
                $month_name = $this->admin_model->get_year($i);// get full name of month by date query
                ?>
                "<?php echo $month_name; ?>", // echo the whole month of the year
                <?php }; ?>
            ],
