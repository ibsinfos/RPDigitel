...
function btn_create($uri)
{
    return anchor($uri, '<i class="fa fa-file"></i>', array('class' => "btn btn-primary btn-xs", 'title' => 'Create Format', 'data-toggle' => 'tooltip', 'data-placement' => 'top'));
}

function btn_upload_data( $uri )
{
   return anchor($uri, '<i class="fa fa-file"></i>', array('class' => "btn btn-primary btn-xs", 'title' => 'Upload Data', 'data-toggle' => 'tooltip', 'data-placement' => 'top'));

}
function btn_convert_lead( $uri )
{
   return anchor($uri, '<i class="fa fa-external-link-square"></i>', array('class' => "btn btn-primary btn-xs", 'title' => 'Convert to Lead', 'data-toggle' => 'tooltip', 'data-placement' => 'top'));
...
function btn_view_format($uri)
{
    return anchor($uri, '<span class="fa fa-list-alt"></span>', array('class' => "btn btn-info btn-xs", 'data-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'View Format'));
}

function btn_view_list($uri)
{
    return anchor($uri, '<span class="fa fa-list-alt"></span>', array('class' => "btn btn-info btn-xs", 'data-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'View List'));
}

function btn_view_column($uri)
{
    return anchor($uri, '<span class="fa fa-list-alt"></span>', array('class' => "btn btn-info btn-xs", 'data-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'View Columns'));
}
...
function btn_back()
{
    return "<button type='submit' name='add' value='1' class='btn btn-info' 'onclick' => 'javascript:history.back()' >" . lang('back') . "</button>";
}

function btn_add_column( $uri )
{
    return anchor($uri, '<span class="fa fa-pencil-square-o"></span>', array('class' => "btn btn-info btn-xs", 'data-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'Add Column'));
}
...
function btn_upload($uri){     
	return anchor($uri, '<span class="fa fa-upload"></span>', array('class' => "btn btn-danger btn-xs", 'title' => 'Edit', 'data-toggle' => 'tooltip', 'data-placement' => 'top', 'data-toggle' => 'modal', 'data-target' => '#myModal'));
}

function btn_assign($uri){     
	return anchor($uri, '<span class="fa fa-user"></span>', array('class' => "btn btn-danger btn-xs", 'title' => 'Change User', 'data-toggle' => 'tooltip', 'data-placement' => 'top', 'data-toggle' => 'modal', 'data-target' => '#myModal'));
}

function btn_allocate($uri){     
	return anchor($uri, '<span class="fa fa-user"></span>', array('class' => "btn btn-danger btn-xs", 'title' => 'Assign User', 'data-toggle' => 'tooltip', 'data-placement' => 'top', 'data-toggle' => 'modal', 'data-target' => '#myModal'));
}

function btn_unallocate($uri){   
	 return "<button data-toggle='tooltip' title='Unallocate' data-placement='top' type='button'  class='btn btn-xs btn-success' id='btn_unallocate'><i class='fa fa-chain-broken'></i></button>";  
	//return anchor($uri, '<span class="fa fa-chain-broken"></span>', array('class' => "btn btn-danger btn-xs", 'title' => 'Assign User', 'data-toggle' => 'tooltip', 'data-placement' => 'top', 'data-toggle' => 'modal', 'data-target' => '#myModal'));
}
function btn_assign_users($uri){     
	return anchor($uri, '<span class="fa fa-users"></span>', array('class' => "btn btn-danger btn-xs", 'title' => 'Leads', 'data-toggle' => 'tooltip', 'data-placement' => 'top', 'data-toggle' => 'modal', 'data-target' => '#myModal'));
}