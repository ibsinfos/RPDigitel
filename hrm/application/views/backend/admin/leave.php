                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <?php if($row['status'] == 0 || $row['status'] == 2) { ?>
                                <li>
                                    <a href="<?php echo base_url(); ?>index.php?admin/leave/approve/<?php echo $row['leave_id']; ?>">
                            ...
                            <?php } if($row['status'] == 0 || $row['status'] == 1) { ?>
                                <li>
                                    <a href="<?php echo base_url(); ?>index.php?admin/leave/decline/<?php echo $row['leave_id']; ?>">
                            ...
                            <li>
                                <a href="#" onclick="confirm_modal_hard_reload('<?php echo base_url(); ?>index.php?admin/leave/delete/<?php echo $row['leave_id']; ?>');">
